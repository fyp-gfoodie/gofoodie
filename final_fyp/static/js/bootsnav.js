...
(function ($) {
  ...
  var bootsnav = {
    ...
    event: function () {
      ...
      $('nav.navbar.bootsnav .attr-nav').each(function () {
        $('li.side-menu1 > a', this).on('click', function (e) {
          e.preventDefault();
          $('nav.navbar.bootsnav > .side1').toggleClass('on');
          $('body').toggleClass('on-side');
        });
      });
      $('.side1 .close-side').on('click', function (e) {
        e.preventDefault();
        $('nav.navbar.bootsnav > .side1').removeClass('on');
        $('body').removeClass('on-side');
      });
